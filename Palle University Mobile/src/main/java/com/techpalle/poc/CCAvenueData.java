...
/**
 * Created by skillgun on 1/1/2016.
 */
public class CCAvenueData {
    private String order_id,
            ...
            mer_amount , eci_value; //ccavenue specific

    private String palle_course_name, palle_course_id, palle_email; //palle specific

    public String getPalle_course_name() {
        return palle_course_name;
    }

    public void setPalle_course_name(String palle_course_name) {
        this.palle_course_name = palle_course_name;
    }

    public String getPalle_course_id() {
        return palle_course_id;
    }

    public void setPalle_course_id(String palle_course_id) {
        this.palle_course_id = palle_course_id;
    }

    public String getPalle_email() {
        return palle_email;
    }

    public void setPalle_email(String palle_email) {
        this.palle_email = palle_email;
    }
